package com.example.administrator.shiyuji.ui.activity.picture;
...
public class PicsActivity extends BaseActivity implements ViewPager.OnPageChangeListener {
    ...
    public void finish() {
        super.finish();
        AisenUtils.changeOpenActivityStyle(PicsActivity.this);
    }
    ...
    class MyViewPagerAdapter extends FragmentPagerAdapter {
        ...
        protected String makeFragmentName(int position) {
            return KeyGenerator.generateMD5(getPicture(position).getThumbnail_pic()+position);
        }
